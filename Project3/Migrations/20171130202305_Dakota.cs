        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GroceryAmount = table.Column<decimal>(nullable: false),
                    GroceryListId = table.Column<int>(nullable: false),
                    GroceryName = table.Column<string>(nullable: false),
                    IsCheckedOff = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroceryListUsers", x => new { x.GroceryListId, x.UserId });
                    table.ForeignKey(
